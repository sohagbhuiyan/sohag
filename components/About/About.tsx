    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(
          (t) => (
            <div className="flex items-start gap-3">
              <div className="flex-1">
                <p className="font-semibold text-sm mb-1">Failed to Send Message</p>
                <p className="text-xs text-gray-600">
                  {result.error || "Please try again or email me directly at sohagbhuiyan778@gmail.com"}
                </p>
              </div>
              <button
                onClick={() => toast.dismiss(t.id)}
      ...
      toast.error(
        (t) => (
          <div className="flex items-start gap-3">
            <div className="flex-1">
              <p className="font-semibold text-sm mb-1">Network Error</p>
              <p className="text-xs text-gray-600">
              ...
              <div className="relative bg-gradient-to-br from-card/90 via-card/80 to-card/90 backdrop-blur-xl border border-primary/20 rounded-2xl p-6 md:p-8 overflow-hidden">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 relative z-10">
                  ...
                  <motion.button
                    ...
                    viewport={{ once: true }}
                    className="relative w-full group overflow-hidden disabled:opacity-60 disabled:cursor-not-allowed"
                  >
